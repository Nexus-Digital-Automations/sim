...
async function testBasicFunctionality() {
  try {
    ...
    const billingOpsModule = await import(
      './apps/sim/lib/copilot/tools/server/billing/billing-operations.js'
    )
    const analyticsModule = await import(
      './apps/sim/lib/copilot/tools/server/billing/usage-analytics.js'
    )
