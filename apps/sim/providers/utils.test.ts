...
describe("Model Capabilities", () => {
  describe("supportsTemperature", () => {
    ...
    it.concurrent(
      ...
      () => {
        ...
        expect(
          supportsTemperature("openrouter/anthropic/claude-3.5-sonnet"),
        ).toBe(true);
  ...
  describe("getMaxTemperature", () => {
    ...
    it.concurrent(
      ...
      () => {
        expect(
          getMaxTemperature("openrouter/anthropic/claude-3.5-sonnet"),
        ).toBe(2);
  ...
  describe("Model Constants", () => {
    ...
    it.concurrent(
      "should have correct models in MODELS_WITH_REASONING_EFFORT",
      () => {
        ...
        expect(MODELS_WITH_REASONING_EFFORT).not.toContain(
          "azure/gpt-5-chat-latest",
        );
    ...
    it.concurrent(
      "should have same models in both reasoning effort and verbosity arrays",
      () => {
        // GPT-5 models that support reasoning effort should also support verbosity and vice versa
        expect(MODELS_WITH_REASONING_EFFORT.sort()).toEqual(
          MODELS_WITH_VERBOSITY.sort(),
        );
      },
    );
  });
