...
import { HelpCircle, Lightbulb, Play, Settings, Zap } from 'lucide-react'
...
function getContextualHelp(context: WorkflowHelpContext) {
  ...
  if (workflowState === 'empty') {
    return {
      ...
      content: 'Start by dragging a block from the toolbar to the canvas, or click the "+" button to add your first block.',
      actions: [
  ...
  if (workflowState === 'creating') {
    return {
      ...
      content: 'Great start! Add more blocks and connect them to create your automation. Each workflow needs a trigger to start.',
      actions: [
        { label: 'Learn About Triggers', action: 'show_triggers_help', variant: 'default' as const },
  ...
  if (workflowState === 'running') {
    return {
      ...
      content: 'Your workflow is currently running. Watch the highlighted blocks to see the execution progress.',
      actions: [
  ...
  return {
    ...
    content: 'You can add blocks, create connections, and configure your workflow. Click the help button for more guidance.',
    actions: [
      { label: 'Open Help Panel', action: 'open_help_panel', variant: 'default' as const }
    ],
    helpType: 'info' as const
  }
}
...
const WORKFLOW_TOUR_STEPS: HelpTourStep[] = [
  {
    ...
    content: 'Let\'s take a quick tour of the workflow editor. You\'ll learn how to create and manage your automations.',
  ...
  },
  {
    id: 'toolbar',
    title: 'Block Toolbar',
    content: 'Drag blocks from here to add them to your workflow. Each block performs a specific function like sending emails or processing data.',
  ...
  },
  {
    ...
    content: 'This is where you build your workflow. Drop blocks here and connect them to create your automation.',
  ...
  },
  {
    id: 'control-bar',
    title: 'Control Bar',
    content: 'Use these controls to run, test, and save your workflow. The play button executes your automation.',
  ...
  },
  {
    ...
    content: 'When you select a block, this panel shows its configuration options. This is where you set up how each block works.',
...
const CanvasHelpOverlay: React.FC<CanvasHelpOverlayProps> = ({
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10">
      <div className="bg-background/95 backdrop-blur-sm border rounded-lg p-8 max-w-md text-center shadow-lg pointer-events-auto">
        <Lightbulb className="h-8 w-8 mx-auto mb-4 text-yellow-500" />
        ...
        <div className="flex gap-2 justify-center">
          <Button
            onClick={() => onHelpAction('start_tour')}
            className="gap-2"
          >
          ...
          <Button
            variant="outline"
            onClick={() => onHelpAction('open_templates')}
          >
            Browse Templates
          </Button>
        </div>
...
export const HelpWorkflowIntegration: React.FC<HelpWorkflowIntegrationProps> = ({
  ...
  // Handle help actions
  const handleHelpAction = useCallback((action: string, context?: any) => {
        ...
        {contextualHelp.priority === 'high' && (
          <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-20">
            <HelpTooltip
              ...
              className="max-w-md"
            >
              <div className="bg-primary text-primary-foreground px-4 py-2 rounded-lg shadow-lg cursor-pointer">
