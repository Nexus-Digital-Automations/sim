          ...
          >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Currently in <span className="font-medium text-primary">{currentMode}</span> mode
                  </p>
                </div>
              </div>
                    ...
                    <div className="space-y-3">
                      {categoryShortcuts.map((shortcut, index) => (
                        ...
                        >
                          ...
                          <kbd className="inline-flex items-center rounded bg-background px-2 py-1 text-xs font-medium text-foreground ring-1 ring-border">
            ...
            <div className="border-t border-border px-6 py-4">
              <div className="flex items-center justify-between text-xs text-muted-foreground">
                <span>Press <kbd className="rounded bg-muted px-1 py-0.5">?</kbd> to toggle this help</span>
                <span>Press <kbd className="rounded bg-muted px-1 py-0.5">Esc</kbd> to close</span>
              </div>
            </div>
          </motion.div>
        </>
...
export function QuickShortcutHints({ className }: { className?: string }) {
  ...
  return (
    <motion.div
      className={cn(
        'fixed bottom-6 left-6 z-30 rounded-lg bg-background/95 backdrop-blur-sm ring-1 ring-border',
        className
      )}
