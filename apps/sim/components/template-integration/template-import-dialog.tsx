...
import type { Template, TemplateCustomization } from '@/lib/templates/types'
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        {conflicts.map((conflict, index) => (
                          <div key={index} className="p-3 rounded-lg border bg-yellow-50 dark:bg-yellow-900/20">
