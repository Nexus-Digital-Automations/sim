...
import { Bot, Cloud, Settings, AlertCircle, Loader2 } from 'lucide-react'
...
export const UnifiedCopilot = forwardRef<UnifiedCopilotRef, UnifiedCopilotProps>(({
  ...
  const setInputValueAndFocus = useCallback((value: string) => {
  ...
  }), [switchToLocal, switchToExternal, getCurrentMode, createNewChat, selectAgent, setInputValueAndFocus])
    ...
    return (
      <div className={cn('flex h-full w-full items-center justify-center', className)}>
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-muted-foreground">Initializing copilot systems...</p>
        </div>
      </div>
    )
  }
            ...
            <CardContent className="p-4">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <h3 className="text-sm font-medium">Choose Copilot Mode</h3>
                  <Button
                    variant="ghost"
                    size="sm"
