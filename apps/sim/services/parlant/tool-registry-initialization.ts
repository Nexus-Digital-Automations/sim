...
import { toolRegistry, ENHANCED_TOOL_DESCRIPTIONS } from './tool-adapter'
...
export const COMPREHENSIVE_TOOL_DESCRIPTIONS: Record<string, EnhancedToolDescription> = {
  ...
  microsoft_teams: {
    ...
    longDescription: 'Integrate with Microsoft Teams to send messages, create posts, and manage team communications. Supports rich formatting, file attachments, and channel management. Perfect for enterprise team collaboration and automated notifications.',
    usageExamples: [
  ...
  discord: {
    ...
    longDescription: 'Connect with Discord communities by sending messages, managing channels, and creating automated notifications. Supports rich embeds, file attachments, and bot interactions. Great for gaming communities, developer teams, and online communities.',
    usageExamples: [
  ...
  whatsapp: {
    ...
    longDescription: 'Integrate WhatsApp Business API for customer communications, support messages, and marketing campaigns. Supports text messages, media attachments, and message templates. Perfect for customer service and business messaging.',
    usageExamples: [
  ...
  mysql: {
    ...
    longDescription: 'Connect to MySQL databases to execute queries, manage data, and perform database operations. Supports complex SQL operations, transactions, and data analysis. Essential for data-driven applications and analytics.',
    usageExamples: [
  ...
  postgresql: {
    ...
    longDescription: 'Connect to PostgreSQL databases for advanced SQL operations, JSON queries, and complex data analysis. Supports advanced PostgreSQL features like arrays, JSON operations, and window functions.',
    usageExamples: [
  ...
  s3: {
    ...
    longDescription: 'Interact with Amazon S3 for file storage, backup, and content distribution. Supports file uploads, downloads, folder management, and access control. Essential for scalable file storage and content delivery.',
    usageExamples: [
  ...
  google_drive: {
    ...
    longDescription: 'Integrate with Google Drive for file management, sharing, and collaboration. Supports file uploads, downloads, folder creation, and permission management. Perfect for document sharing and team collaboration.',
    usageExamples: [
  ...
  google: {
    ...
    longDescription: 'Perform web searches using Google Search API to find information, articles, and resources. Returns structured search results with titles, descriptions, and URLs. Essential for research and information gathering.',
    usageExamples: [
  ...
  wikipedia: {
    ...
    longDescription: 'Access Wikipedia articles and information for research, fact-checking, and knowledge gathering. Provides structured article content, summaries, and related information. Perfect for educational and informational content.',
    usageExamples: [
  ...
  schedule: {
    ...
    longDescription: 'Create scheduled tasks, recurring workflows, and time-based automation. Supports cron expressions, one-time scheduling, and recurring patterns. Essential for automated reporting, maintenance tasks, and periodic operations.',
    usageExamples: [
  ...
  webhook: {
    ...
    longDescription: 'Send HTTP POST requests to external webhooks for system integration and event notifications. Supports custom headers, payload formatting, and retry logic. Perfect for triggering external workflows and system notifications.',
    usageExamples: [
