...
// ================================
import { setupEnhancedTestMocks, createEnhancedMockRequest, enhancedMockUser } from '@/app/api/__test-utils__/enhanced-utils'
...
export function testPagination(
  ...
  return async () => {
    ...
    const request = new NextRequest(
      `http://localhost:3000${endpoint}?page=1&limit=10`
    )
