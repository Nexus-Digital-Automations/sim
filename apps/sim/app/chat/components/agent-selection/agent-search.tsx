    ...
    <div className={`space-y-4 ${className}`}>
      ...
      {hasActiveFilters && (
        <div className="flex items-center space-x-2 flex-wrap">
          ...
          {filters.hasGuidelines !== null && (
            <Badge variant="secondary" className="cursor-pointer" onClick={() => setFilters(prev => ({ ...prev, hasGuidelines: null }))}>
          ...
          {filters.hasJourneys !== null && (
            <Badge variant="secondary" className="cursor-pointer" onClick={() => setFilters(prev => ({ ...prev, hasJourneys: null }))}>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      setFilters(prev => ({
                        ...prev,
                        hasGuidelines: checked ? true : (filters.hasGuidelines === true ? null : false)
                      }))
                    }
                  />
                  <Label htmlFor="has-guidelines" className="text-sm cursor-pointer">
                    Has Guidelines
                  </Label>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="has-journeys" className="text-sm cursor-pointer">
                    Has Journeys
                  </Label>
                </div>
              </div>
