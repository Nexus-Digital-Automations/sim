    ...
    const templateData: Partial<WorkflowTemplate> = {
      ...
      parameters: [
        ...
        },
        {
          ...
          validation: {
            options: [
              { value: 'low', label: 'Low Priority', description: 'Non-urgent issues' },
              { value: 'medium', label: 'Medium Priority', description: 'Standard issues' },
              { value: 'high', label: 'High Priority', description: 'Urgent issues' },
              {
                value: 'critical',
                label: 'Critical',
