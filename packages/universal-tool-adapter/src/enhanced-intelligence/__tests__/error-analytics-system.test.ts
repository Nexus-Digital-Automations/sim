...
describe('ErrorAnalyticsSystem', () => {
  ...
  describe('Error Event Recording', () => {
    ...
    it('should emit analytics events during recording', (done) => {
      analyticsSystem.once('error_recorded', (event) => {
        ...
        expect(event.error instanceof Error ? error.message : String(error)).toBe(
          'Event emission test error'
        )
        done()
      })
  ...
  describe('Recovery Tracking', () => {
    ...
    it('should record recovery plans', async () => {
      ...
      await expect(analyticsSystem.recordRecoveryPlan(eventId, recoveryPlan)).resolves.not.toThrow()
    ...
    it('should record selected recovery actions', async () => {
      ...
      await expect(
        analyticsSystem.recordSelectedAction(eventId, selectedAction)
    ...
    it('should record recovery outcomes', async () => {
      ...
      await expect(analyticsSystem.recordRecoveryOutcome(eventId, outcome)).resolves.not.toThrow()
    })
    ...
    it('should record user feedback', async () => {
      ...
      await expect(analyticsSystem.recordUserFeedback(eventId, feedback)).resolves.not.toThrow()
    })
  })
      ...
      const testData = [
        ...
        },
        {
          ...
          outcome: {
            ...
            attemptCount: 3,
            resolutionMethod: 'manual_intervention' as const,
          },
          type: 'NetworkError',
        },
        {
  ...
  describe('System Performance Analytics', () => {
    ...
    it('should track memory usage trends', async () => {
      ...
      expect(analytics.performance.memoryUsage.peak).toBeGreaterThanOrEqual(
        analytics.performance.memoryUsage.average
      )
    })
  })
  ...
  describe('Data Export', () => {
    ...
    it('should throw error for unsupported format', async () => {
      await expect(analyticsSystem.exportAnalyticsData('pdf' as any, 24)).rejects.toThrow(
