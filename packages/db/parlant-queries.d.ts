...
import type { AgentFilters, AgentWithRelations, BatchOperationResult, CreateAgentParams, CreateEventParams, CreateSessionParams, EventFilters, PaginatedResponse, PaginationParams, ParlantAgent, ParlantError, ParlantEvent, ParlantSession, SessionFilters, SessionWithRelations } from './parlant-types';
...
export declare class ParlantAgentQueries {
     ...
     */
    getMany(filters?: AgentFilters, pagination?: PaginationParams): Promise<PaginatedResponse<ParlantAgent>>;
    /**
     * Create new agent
     */
...
export declare class ParlantSessionQueries {
     ...
     */
    getMany(filters?: SessionFilters, pagination?: PaginationParams): Promise<PaginatedResponse<ParlantSession>>;
    /**
     * Create new session
     */
...
export declare class ParlantEventQueries {
     ...
     */
    getBySession(sessionId: string, filters?: Omit<EventFilters, 'sessionId'>, pagination?: PaginationParams): Promise<PaginatedResponse<ParlantEvent>>;
    /**
     * Create new event
     */
 ...
 */
export declare function batchInsert<T>(db: Database, table: any, items: T[], batchSize?: number): Promise<BatchOperationResult<T>>;
/**
