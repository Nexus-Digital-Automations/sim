...
export type ParlantAgentUpdate = Partial<Omit<ParlantAgentInsert, 'id'>> & { id: string }
export type ParlantSessionUpdate = Partial<Omit<ParlantSessionInsert, 'id'>> & { id: string }
...
export type AgentWithRelations = ParlantAgent & {
  ...
  knowledgeBases?: (ParlantAgentKnowledgeBase & { knowledgeBase: { id: string; name: string } })[]
