import type { ParlantAgent, ParlantAgentKnowledgeBase, ParlantAgentTool, ParlantEvent, ParlantGuideline, ParlantJourney, ParlantJourneyGuideline, ParlantJourneyState, ParlantJourneyTransition, ParlantSession, ParlantTool, ParlantToolIntegration, ParlantVariable } from './parlant-types';
/**
 ...
 */
export type ParlantEventContent = CustomerMessageContent | AgentMessageContent | ToolCallContent | ToolResultContent | StatusUpdateContent | JourneyTransitionContent | VariableUpdateContent;
/**
...
export interface FinalStateConfig extends BaseJourneyStateConfig {
    ...
    completion: {
        ...
        followUpActions?: Array<{
            type: 'schedule_reminder' | 'send_email' | 'create_task' | 'trigger_workflow';
            parameters: Record<string, unknown>;
            delay?: string;
        }>;
    };
 ...
 */
export type JourneyStateConfiguration = ChatStateConfig | ToolStateConfig | DecisionStateConfig | FinalStateConfig;
/**
 ...
 */
export type ToolIntegrationConfiguration = CustomToolIntegration | WorkflowBlockIntegration | McpServerIntegration | ExternalApiIntegration;
/**
...
export interface CustomerSessionContext {
    ...
    entryPoint: {
        source: 'support_portal' | 'website' | 'email_link' | 'mobile_app' | 'chat_widget';
        ticketId?: string;
        campaignId?: string;
        context?: Record<string, unknown>;
    };
 ...
 */
export type SessionContext = AnonymousSessionContext | AuthenticatedSessionContext | CustomerSessionContext;
/**
 * Full event with typed content
 */
export interface TypedParlantEvent<T extends ParlantEventContent = ParlantEventContent> extends Omit<ParlantEvent, 'content'> {
    content: T;
 ...
 */
export interface TypedJourneyState<T extends JourneyStateConfiguration = JourneyStateConfiguration> extends Omit<ParlantJourneyState, 'toolConfig'> {
    configuration: T;
}
/**
 * Tool with typed integration
 */
export interface TypedParlantTool<T extends ToolIntegrationConfiguration = ToolIntegrationConfiguration> extends ParlantTool {
    integrations: Array<ParlantToolIntegration & {
        configuration: T;
    }>;
}
/**
 ...
 */
export interface TypedParlantSession<T extends SessionContext = SessionContext> extends Omit<ParlantSession, 'metadata'> {
    context: T;
    typedMetadata?: Record<string, unknown>;
}
/**
...
export type JourneyQueryResult = ParlantJourney & {
    _relations?: {
        ...
        states?: Array<TypedJourneyState & {
            transitions?: Array<ParlantJourneyTransition & {
 ...
 */
export declare function isCustomerMessageContent(content: ParlantEventContent): content is CustomerMessageContent;
export declare function isAgentMessageContent(content: ParlantEventContent): content is AgentMessageContent;
export declare function isToolCallContent(content: ParlantEventContent): content is ToolCallContent;
export declare function isToolResultContent(content: ParlantEventContent): content is ToolResultContent;
export declare function isJourneyTransitionContent(content: ParlantEventContent): content is JourneyTransitionContent;
/**
 * Journey state configuration type guards
 */
export declare function isChatStateConfig(config: JourneyStateConfiguration): config is ChatStateConfig;
export declare function isToolStateConfig(config: JourneyStateConfiguration): config is ToolStateConfig;
export declare function isDecisionStateConfig(config: JourneyStateConfiguration): config is DecisionStateConfig;
export declare function isFinalStateConfig(config: JourneyStateConfiguration): config is FinalStateConfig;
/**
 * Tool integration type guards
 */
export declare function isCustomToolIntegration(config: ToolIntegrationConfiguration): config is CustomToolIntegration;
export declare function isWorkflowBlockIntegration(config: ToolIntegrationConfiguration): config is WorkflowBlockIntegration;
export declare function isMcpServerIntegration(config: ToolIntegrationConfiguration): config is McpServerIntegration;
/**
 * Session context type guards
 */
export declare function isAnonymousSession(context: SessionContext): context is AnonymousSessionContext;
export declare function isAuthenticatedSession(context: SessionContext): context is AuthenticatedSessionContext;
export declare function isCustomerSession(context: SessionContext): context is CustomerSessionContext;
