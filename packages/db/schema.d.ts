...
export declare const webhookDeliveryStatusEnum: import("drizzle-orm/pg-core").PgEnum<["pending", "in_progress", "success", "failed"]>;
...
export declare const toolStatusEnum: import("drizzle-orm/pg-core").PgEnum<["active", "inactive", "deprecated", "maintenance"]>;
export declare const toolScopeEnum: import("drizzle-orm/pg-core").PgEnum<["global", "workspace", "user"]>;
export declare const toolTypeEnum: import("drizzle-orm/pg-core").PgEnum<["builtin", "custom", "integration", "plugin"]>;
...
export declare const permissionTypeEnum: import("drizzle-orm/pg-core").PgEnum<["admin", "write", "read"]>;
export declare const workspaceInvitationStatusEnum: import("drizzle-orm/pg-core").PgEnum<["pending", "accepted", "rejected", "cancelled"]>;
...
export declare const messageStatusEnum: import("drizzle-orm/pg-core").PgEnum<["pending", "sent", "delivered", "read", "failed"]>, conversationTypeEnum: import("drizzle-orm/pg-core").PgEnum<["direct", "group", "workflow", "support", "onboarding"]>, messageTypeEnum: import("drizzle-orm/pg-core").PgEnum<["text", "tool_call", "tool_result", "system", "error", "media", "file"]>;
...
export declare const agentStatusEnum: import("drizzle-orm/pg-core").PgEnum<["active", "inactive", "archived"]>, sessionModeEnum: import("drizzle-orm/pg-core").PgEnum<["auto", "manual", "paused"]>, sessionStatusEnum: import("drizzle-orm/pg-core").PgEnum<["active", "completed", "abandoned"]>, eventTypeEnum: import("drizzle-orm/pg-core").PgEnum<["customer_message", "agent_message", "tool_call", "tool_result", "status_update", "journey_transition", "variable_update"]>, journeyStateTypeEnum: import("drizzle-orm/pg-core").PgEnum<["chat", "tool", "decision", "final"]>, compositionModeEnum: import("drizzle-orm/pg-core").PgEnum<["fluid", "strict"]>;
