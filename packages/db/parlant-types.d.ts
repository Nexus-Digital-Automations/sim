...
import type { agentStatusEnum, compositionModeEnum, eventTypeEnum, journeyStateTypeEnum, parlantAgent, parlantAgentKnowledgeBase, parlantAgentTool, parlantCannedResponse, parlantEvent, parlantGuideline, parlantJourney, parlantJourneyGuideline, parlantJourneyState, parlantJourneyTransition, parlantSession, parlantTerm, parlantTool, parlantToolIntegration, parlantVariable, sessionModeEnum, sessionStatusEnum } from './parlant-schema';
/**
 ...
 */
export type ParlantJourneyTransition = InferSelectModel<typeof parlantJourneyTransition>;
/**
 ...
 */
export type ParlantCannedResponse = InferSelectModel<typeof parlantCannedResponse>;
/**
 ...
 */
export type ParlantJourneyGuideline = InferSelectModel<typeof parlantJourneyGuideline>;
/**
 * Parlant Agent Knowledge Base - Junction table for agent-knowledge base relationships
 */
export type ParlantAgentKnowledgeBase = InferSelectModel<typeof parlantAgentKnowledgeBase>;
/**
 * Parlant Tool Integration - Junction table for tool integrations
 */
export type ParlantToolIntegration = InferSelectModel<typeof parlantToolIntegration>;
/**
 ...
 */
export type ParlantJourneyStateInsert = InferInsertModel<typeof parlantJourneyState>;
/**
 * Parlant Journey Transition Insert - Type for creating new journey transitions
 */
export type ParlantJourneyTransitionInsert = InferInsertModel<typeof parlantJourneyTransition>;
/**
 ...
 */
export type ParlantCannedResponseInsert = InferInsertModel<typeof parlantCannedResponse>;
/**
 ...
 */
export type ParlantJourneyGuidelineInsert = InferInsertModel<typeof parlantJourneyGuideline>;
/**
 * Parlant Agent Knowledge Base Insert - Type for creating new agent-knowledge base relationships
 */
export type ParlantAgentKnowledgeBaseInsert = InferInsertModel<typeof parlantAgentKnowledgeBase>;
/**
 * Parlant Tool Integration Insert - Type for creating new tool integrations
 */
export type ParlantToolIntegrationInsert = InferInsertModel<typeof parlantToolIntegration>;
/**
...
export type ParlantGuidelineUpdate = Partial<Omit<ParlantGuidelineInsert, 'id'>> & {
    id: string;
};
...
export type ParlantVariableUpdate = Partial<Omit<ParlantVariableInsert, 'id'>> & {
    id: string;
};
...
export type ParlantAgentToolUpdate = Partial<Omit<ParlantAgentToolInsert, 'id'>> & {
    id: string;
};
export type ParlantJourneyGuidelineUpdate = Partial<Omit<ParlantJourneyGuidelineInsert, 'id'>> & {
    id: string;
};
export type ParlantAgentKnowledgeBaseUpdate = Partial<Omit<ParlantAgentKnowledgeBaseInsert, 'id'>> & {
    id: string;
};
...
export type ParlantError = {
    code: 'AGENT_NOT_FOUND' | 'SESSION_NOT_FOUND' | 'INVALID_EVENT' | 'JOURNEY_INVALID' | 'TOOL_NOT_FOUND' | 'GUIDELINE_CONFLICT' | 'WORKSPACE_ACCESS_DENIED' | 'VALIDATION_ERROR';
    message: string;
