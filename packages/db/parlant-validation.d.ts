 ...
 */
export declare const jsonSchema: z.ZodUnion<[z.ZodRecord<z.ZodString, z.ZodUnknown>, z.ZodArray<z.ZodUnknown, "many">]>;
...
export declare const eventTypeSchema: z.ZodEnum<["customer_message", "agent_message", "tool_call", "tool_result", "status_update", "journey_transition", "variable_update"]>;
...
export declare const updateAgentSchema: z.ZodObject<{
    ...
    conversationStyle: z.ZodOptional<z.ZodDefault<z.ZodEnum<["casual", "professional", "technical", "friendly"]>>>;
...
export declare const createEventSchema: z.ZodObject<{
    ...
    offset: z.ZodNumber;
    eventType: z.ZodEnum<["customer_message", "agent_message", "tool_call", "tool_result", "status_update", "journey_transition", "variable_update"]>;
    ...
    offset: number;
    eventType: "customer_message" | "agent_message" | "tool_call" | "tool_result" | "status_update" | "journey_transition" | "variable_update";
 ...
 */
export declare const createJourneyStateSchema: z.ZodEffects<z.ZodObject<{
 ...
 */
export declare const createVariableSchema: z.ZodEffects<z.ZodObject<{
    agentId: z.ZodString;
...
export declare const agentFilterSchema: z.ZodObject<{
    workspaceId: z.ZodOptional<z.ZodString>;
    status: z.ZodOptional<z.ZodUnion<[z.ZodEnum<["active", "inactive", "archived"]>, z.ZodArray<z.ZodEnum<["active", "inactive", "archived"]>, "many">]>>;
    compositionMode: z.ZodOptional<z.ZodUnion<[z.ZodEnum<["fluid", "strict"]>, z.ZodArray<z.ZodEnum<["fluid", "strict"]>, "many">]>>;
...
export declare const sessionFilterSchema: z.ZodObject<{
    ...
    userId: z.ZodOptional<z.ZodString>;
    customerId: z.ZodOptional<z.ZodString>;
    status: z.ZodOptional<z.ZodUnion<[z.ZodEnum<["active", "completed", "abandoned"]>, z.ZodArray<z.ZodEnum<["active", "completed", "abandoned"]>, "many">]>>;
    mode: z.ZodOptional<z.ZodUnion<[z.ZodEnum<["auto", "manual", "paused"]>, z.ZodArray<z.ZodEnum<["auto", "manual", "paused"]>, "many">]>>;
    ...
    status?: "completed" | "active" | "abandoned" | ("completed" | "active" | "abandoned")[] | undefined;
...
export declare function formatValidationErrors(zodError: z.ZodError): {
    field: string;
    message: string;
    code: "custom" | "invalid_literal" | "invalid_type" | "invalid_enum_value" | "invalid_union" | "unrecognized_keys" | "invalid_union_discriminator" | "invalid_arguments" | "invalid_return_type" | "invalid_string" | "not_multiple_of" | "invalid_intersection_types" | "invalid_date" | "not_finite" | "too_big" | "too_small";
    value: any;
}[];
export declare const parlantSchemas: {
    ...
    createJourneyState: z.ZodEffects<z.ZodObject<{
        journeyId: z.ZodString;
        name: z.ZodString;
        stateType: z.ZodEnum<["chat", "tool", "decision", "final"]>;
        chatPrompt: z.ZodOptional<z.ZodString>;
    ...
    createVariable: z.ZodEffects<z.ZodObject<{
        agentId: z.ZodString;
        sessionId: z.ZodOptional<z.ZodString>;
        key: z.ZodString;
        scope: z.ZodDefault<z.ZodEnum<["session", "customer", "global"]>>;
    ...
    paginatedResponse: <T extends z.ZodTypeAny>(dataSchema: T) => z.ZodObject<{
        data: z.ZodArray<T, "many">;
        pagination: z.ZodObject<{
            page: z.ZodNumber;
            pageSize: z.ZodNumber;
