...
>;
export declare const journeyStateTypeSchema: z.ZodEnum<
...
export declare const updateAgentSchema: z.ZodObject<
  {
    ...
    compositionMode: z.ZodOptional<
      z.ZodDefault<z.ZodEnum<["fluid", "strict"]>>
    >;
    ...
    piiHandlingMode: z.ZodOptional<
      z.ZodDefault<z.ZodEnum<["strict", "standard", "relaxed"]>>
    >;
    integrationMetadata: z.ZodOptional<
      z.ZodDefault<z.ZodRecord<z.ZodString, z.ZodUnknown>>
    >;
    customConfig: z.ZodOptional<
      z.ZodDefault<z.ZodRecord<z.ZodString, z.ZodUnknown>>
    >;
  } & {
    id: z.ZodString;
...
export declare const sessionResponseSchema: z.ZodObject<
  {
    ...
    sessionType: z.ZodDefault<
      z.ZodEnum<["conversation", "support", "onboarding", "survey"]>
    >;
...
export declare const agentFilterSchema: z.ZodObject<
  {
    ...
    compositionMode: z.ZodOptional<
      z.ZodUnion<
        [
          z.ZodEnum<["fluid", "strict"]>,
          z.ZodArray<z.ZodEnum<["fluid", "strict"]>, "many">,
        ]
      >
    >;
    modelProvider: z.ZodOptional<
      ...
      z.ZodObject<
        {
          ...
          dataRetentionDays: z.ZodDefault<z.ZodNumber>;
          allowDataExport: z.ZodDefault<z.ZodBoolean>;
          piiHandlingMode: z.ZodDefault<
            z.ZodEnum<["strict", "standard", "relaxed"]>
          >;
          integrationMetadata: z.ZodDefault<
            z.ZodRecord<z.ZodString, z.ZodUnknown>
          >;
          customConfig: z.ZodDefault<z.ZodRecord<z.ZodString, z.ZodUnknown>>;
        },
  ...
  updateSession: z.ZodObject<
    {
      ...
      customerId: z.ZodOptional<z.ZodOptional<z.ZodString>>;
      mode: z.ZodOptional<
        z.ZodDefault<z.ZodEnum<["auto", "manual", "paused"]>>
      >;
      title: z.ZodOptional<z.ZodOptional<z.ZodString>>;
      metadata: z.ZodOptional<
        z.ZodDefault<z.ZodRecord<z.ZodString, z.ZodUnknown>>
