 ...
 */
export declare const messageStatusEnum: import("drizzle-orm/pg-core").PgEnum<["pending", "sent", "delivered", "read", "failed"]>;
export declare const conversationTypeEnum: import("drizzle-orm/pg-core").PgEnum<["direct", "group", "workflow", "support", "onboarding"]>;
export declare const messageTypeEnum: import("drizzle-orm/pg-core").PgEnum<["text", "tool_call", "tool_result", "system", "error", "media", "file"]>;
/**
...
export declare const chatPersistenceEnums: {
    messageStatusEnum: import("drizzle-orm/pg-core").PgEnum<["pending", "sent", "delivered", "read", "failed"]>;
    conversationTypeEnum: import("drizzle-orm/pg-core").PgEnum<["direct", "group", "workflow", "support", "onboarding"]>;
    messageTypeEnum: import("drizzle-orm/pg-core").PgEnum<["text", "tool_call", "tool_result", "system", "error", "media", "file"]>;
};
/**
