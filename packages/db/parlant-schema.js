 ...
 */
export const parlantAgent = pgTable('parlant_agent', {
 ...
 */
export const parlantSession = pgTable('parlant_session', {
    id: uuid('id').primaryKey().defaultRandom(),
 ...
 */
export const parlantEvent = pgTable('parlant_event', {
    id: uuid('id').primaryKey().defaultRandom(),
 ...
 */
export const parlantGuideline = pgTable('parlant_guideline', {
    id: uuid('id').primaryKey().defaultRandom(),
    agentId: uuid('agent_id')
        .notNull()
        .references(() => parlantAgent.id, { onDelete: 'cascade' }),
 ...
 */
export const parlantJourney = pgTable('parlant_journey', {
    id: uuid('id').primaryKey().defaultRandom(),
    agentId: uuid('agent_id')
        .notNull()
        .references(() => parlantAgent.id, { onDelete: 'cascade' }),
 ...
 */
export const parlantJourneyState = pgTable('parlant_journey_state', {
    id: uuid('id').primaryKey().defaultRandom(),
 ...
 */
export const parlantJourneyTransition = pgTable('parlant_journey_transition', {
    id: uuid('id').primaryKey().defaultRandom(),
    journeyId: uuid('journey_id')
        .notNull()
        .references(() => parlantJourney.id, { onDelete: 'cascade' }),
 ...
 */
export const parlantVariable = pgTable('parlant_variable', {
    id: uuid('id').primaryKey().defaultRandom(),
    agentId: uuid('agent_id')
        .notNull()
        .references(() => parlantAgent.id, { onDelete: 'cascade' }),
 ...
 */
export const parlantTool = pgTable('parlant_tool', {
    id: uuid('id').primaryKey().defaultRandom(),
    workspaceId: text('workspace_id')
        .notNull()
        .references(() => workspace.id, { onDelete: 'cascade' }),
 ...
 */
export const parlantTerm = pgTable('parlant_term', {
    id: uuid('id').primaryKey().defaultRandom(),
    agentId: uuid('agent_id')
        .notNull()
        .references(() => parlantAgent.id, { onDelete: 'cascade' }),
 ...
 */
export const parlantCannedResponse = pgTable('parlant_canned_response', {
    id: uuid('id').primaryKey().defaultRandom(),
    agentId: uuid('agent_id')
        .notNull()
        .references(() => parlantAgent.id, { onDelete: 'cascade' }),
 ...
 */
export const parlantAgentWorkflow = pgTable('parlant_agent_workflow', {
    id: uuid('id').primaryKey().defaultRandom(),
    agentId: uuid('agent_id')
        .notNull()
        .references(() => parlantAgent.id, { onDelete: 'cascade' }),
 ...
 */
export const parlantAgentApiKey = pgTable('parlant_agent_api_key', {
    id: uuid('id').primaryKey().defaultRandom(),
    agentId: uuid('agent_id')
        .notNull()
        .references(() => parlantAgent.id, { onDelete: 'cascade' }),
 ...
 */
export const parlantSessionWorkflow = pgTable('parlant_session_workflow', {
    id: uuid('id').primaryKey().defaultRandom(),
    sessionId: uuid('session_id')
        .notNull()
        .references(() => parlantSession.id, { onDelete: 'cascade' }),
 ...
 */
export const parlantAgentTool = pgTable('parlant_agent_tool', {
    id: uuid('id').primaryKey().defaultRandom(),
    agentId: uuid('agent_id')
        .notNull()
        .references(() => parlantAgent.id, { onDelete: 'cascade' }),
 ...
 */
export const parlantJourneyGuideline = pgTable('parlant_journey_guideline', {
    id: uuid('id').primaryKey().defaultRandom(),
    journeyId: uuid('journey_id')
        .notNull()
        .references(() => parlantJourney.id, { onDelete: 'cascade' }),
 ...
 */
export const parlantAgentKnowledgeBase = pgTable('parlant_agent_knowledge_base', {
    id: uuid('id').primaryKey().defaultRandom(),
    agentId: uuid('agent_id')
        .notNull()
        .references(() => parlantAgent.id, { onDelete: 'cascade' }),
 ...
 */
export const parlantToolIntegration = pgTable('parlant_tool_integration', {
    id: uuid('id').primaryKey().defaultRandom(),
...
export const parlantWorkflowTemplate = pgTable('parlant_workflow_template', {
    id: uuid('id').primaryKey().defaultRandom(),
    workspaceId: text('workspace_id')
        .notNull()
        .references(() => workspace.id, { onDelete: 'cascade' }),
    ...
    uniqueWorkspaceWorkflowName: uniqueIndex('parlant_workflow_template_unique').on(table.workspaceId, table.workflowId, table.name),
}));
// Template Parameters
export const parlantTemplateParameter = pgTable('parlant_template_parameter', {
    id: uuid('id').primaryKey().defaultRandom(),
    ...
    uniqueTemplateName: uniqueIndex('parlant_template_parameter_unique').on(table.templateId, table.name),
}));
// Conversion Cache for Performance
export const parlantConversionCache = pgTable('parlant_conversion_cache', {
    id: uuid('id').primaryKey().defaultRandom(),
...
export const parlantConversionHistory = pgTable('parlant_conversion_history', {
    id: uuid('id').primaryKey().defaultRandom(),
...
export const parlantJourneyGenerationHistory = pgTable('parlant_journey_generation_history', {
    id: uuid('id').primaryKey().defaultRandom(),
