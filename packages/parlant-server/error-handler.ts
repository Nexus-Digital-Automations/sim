...
export class UniversalErrorHandler {
  ...
  private errorProcessors = new Map<
    ErrorSeverity,
    (error: BaseToolError) => Promise<void>
  >();
  ...
  private initializeErrorProcessors(): void {
    this.errorProcessors.set(
      ErrorSeverity.TRACE,
      this.processTraceError.bind(this),
    );
    this.errorProcessors.set(
      ErrorSeverity.DEBUG,
      this.processDebugError.bind(this),
    );
    this.errorProcessors.set(
      ErrorSeverity.INFO,
      this.processInfoError.bind(this),
    );
    this.errorProcessors.set(
      ErrorSeverity.WARNING,
      this.processWarningError.bind(this),
    );
    this.errorProcessors.set(ErrorSeverity.ERROR, this.processError.bind(this));
    this.errorProcessors.set(
      ErrorSeverity.CRITICAL,
      this.processCriticalError.bind(this),
    );
    this.errorProcessors.set(
      ErrorSeverity.FATAL,
      this.processFatalError.bind(this),
    );
  }
  ...
  private initializeRecoveryStrategies(): void {
    ...
    this.recoveryStrategies.set(
      ...
      this.attemptFallback.bind(this),
    );
    this.recoveryStrategies.set(
    ...
    this.recoveryStrategies.set(
      ...
      this.logManualIntervention.bind(this),
    );
    this.recoveryStrategies.set(
      RecoveryStrategy.NONE,
      this.logNoRecovery.bind(this),
    );
  }
 ...
 */
export const handleError = (error: BaseToolError) =>
  universalErrorHandler.handleError(error);
