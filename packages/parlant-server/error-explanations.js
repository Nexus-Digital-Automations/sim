...
export class ErrorExplanationService {
   ...
   */
  generateExplanation(error, userSkillLevel, format, userContext) {
        ...
        steps.push({
          ...
          instructions: {
            ...
            [UserSkillLevel.INTERMEDIATE]:
              stepTemplate.instructions.intermediate.map((inst) =>
 ...
 */
export const explainError = (error, userSkillLevel, format, userContext) =>
