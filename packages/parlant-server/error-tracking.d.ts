...
export declare class ParlantErrorTracker {
     ...
     */
    trackError(level: ErrorDetails['level'], category: ErrorDetails['category'], service: string, message: string, error?: Error, context?: ParlantLogContext, metadata?: Partial<ErrorDetails['metadata']>): Promise<string>;
    /**
...
export declare const errorTracker: {
    trackWarning: (category: ErrorDetails["category"], service: string, message: string, error?: Error, context?: ParlantLogContext) => Promise<string>;
    trackError: (category: ErrorDetails["category"], service: string, message: string, error?: Error, context?: ParlantLogContext) => Promise<string>;
    trackCritical: (category: ErrorDetails["category"], service: string, message: string, error?: Error, context?: ParlantLogContext) => Promise<string>;
