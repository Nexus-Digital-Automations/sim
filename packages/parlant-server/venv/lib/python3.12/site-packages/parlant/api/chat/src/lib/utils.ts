...
export const exportToCsv = (data: any[], filename: string, options: any = {}) => {
  try {
    const { headers = [], delimiter = ',', includeHeaders = true, dateFormat = 'iso' } = options
...
export const getItemFromIndexedDB = async (
  dbName: string,
  storeName: string,
  key: string,
  indexVals?: { name: string; keyPath: string }
...
export const getIndexedItemsFromIndexedDB = async (
  dbName: string,
  storeName: string,
  indexName: string,
  indexKey: string,
