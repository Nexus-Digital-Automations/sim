 ...
 */
export declare const generateIntelligentExplanation: (
  error: BaseToolError,
  context: ExplanationContext,
) => Promise<IntelligentErrorExplanation>;
export declare const translateErrorMessage: (
  error: BaseToolError,
  targetLanguage: SupportedLanguage,
  context: ExplanationContext,
) => Promise<string>;
export declare const recordUserInteraction: (
  interaction: UserInteraction,
) => Promise<void>;
export declare const processLearningFeedback: (
  feedback: LearningFeedback,
) => Promise<void>;
export declare const getPersonalizedExplanation: (
  error: BaseToolError,
  userId: string,
  preferences?: Partial<ExplanationContext>,
) => Promise<IntelligentErrorExplanation>;
