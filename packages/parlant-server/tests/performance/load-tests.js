...
describe('Parlant Server Performance and Load Tests', () => {
  ...
  describe('Concurrent User Load Tests', () => {
    test('Server handles 50 concurrent agent creation requests', async () => {
      ...
      try {
        ...
        console.log(`✅ Concurrent agent creation: ${successful}/${concurrentRequests} successful`);
    ...
    test('Server handles 100 concurrent session creation requests', async () => {
      if (testAgents.length === 0) {
      ...
      try {
        ...
        console.log(`✅ Concurrent session creation: ${successful}/${concurrentRequests} successful`);
        console.log(`   Total time: ${totalTime}ms, Average: ${avgResponseTime.toFixed(2)}ms`);
        console.log(`   Failed: ${failed}`);
      } catch (error) {
    ...
    test('Server handles 200 concurrent message sending requests', async () => {
      ...
      try {
        ...
        console.log(`✅ Concurrent message sending: ${successful}/${concurrentRequests} successful`);
        console.log(`   Total time: ${totalTime}ms, Average: ${avgResponseTime.toFixed(2)}ms`);
        console.log(`   Failed: ${failed}`);
      } catch (error) {
  ...
  describe('Stress Testing', () => {
    test('Server maintains stability under sustained load', async () => {
      ...
      console.log(`Starting ${durationMinutes} minute stress test with ${requestsPerSecond} req/s`);
