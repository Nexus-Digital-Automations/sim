...
describe('Parlant Agent Management API Tests', () => {
  ...
  describe('Agent Lifecycle Management API', () => {
    test('POST /api/agents - Create new agent', async () => {
      ...
      try {
        const response = await axios.post(`${PARLANT_SERVER_URL}/api/agents`, agentData, {
          headers: {
    ...
    test('GET /api/agents/:id - Get specific agent', async () => {
      ...
      try {
        const response = await axios.get(`${PARLANT_SERVER_URL}/api/agents/${agentId}`, {
          headers: {
            Authorization: `Bearer ${authToken}`,
            'Content-Type': 'application/json',
          },
    ...
    test('DELETE /api/agents/:id - Delete agent', async () => {
      ...
      try {
        ...
        const deleteResponse = await axios.delete(`${PARLANT_SERVER_URL}/api/agents/${agentId}`, {
          headers: {
            Authorization: `Bearer ${authToken}`,
            'Content-Type': 'application/json',
          },
  ...
  describe('Session Management API', () => {
    ...
    test('POST /api/sessions - Create new session', async () => {
      ...
      try {
        const response = await axios.post(`${PARLANT_SERVER_URL}/api/sessions`, sessionData, {
          headers: {
            Authorization: `Bearer ${authToken}`,
            'Content-Type': 'application/json',
          },
    ...
    test('GET /api/sessions/:id - Get session details', async () => {
      ...
      try {
        const response = await axios.get(`${PARLANT_SERVER_URL}/api/sessions/${sessionId}`, {
          headers: {
            Authorization: `Bearer ${authToken}`,
            'Content-Type': 'application/json',
          },
    ...
    test('GET /api/sessions/:id/events - Retrieve session events', async () => {
      ...
      try {
        const response = await axios.get(`${PARLANT_SERVER_URL}/api/sessions/${sessionId}/events`, {
          headers: {
            Authorization: `Bearer ${authToken}`,
            'Content-Type': 'application/json',
          },
  ...
  describe('Error Handling and Validation', () => {
    ...
    test('API handles malformed JSON gracefully', async () => {
      try {
        await axios.post(`${PARLANT_SERVER_URL}/api/agents`, 'invalid json string', {
          headers: {
            Authorization: `Bearer ${authToken}`,
            'Content-Type': 'application/json',
          },
    ...
    test('API enforces rate limiting', async () => {
      ...
      try {
        ...
        console.log(
          `✅ Rate limiting test: ${successful} successful, ${rateLimited} rate limited, ${otherErrors} other errors`
        )
