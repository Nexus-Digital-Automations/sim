 ...
 */
export const generateIntelligentExplanation = (error, context) =>
  errorIntelligenceService.generateIntelligentExplanation(error, context)
export const translateErrorMessage = (error, targetLanguage, context) =>
  errorIntelligenceService.translateErrorMessage(error, targetLanguage, context)
export const recordUserInteraction = (interaction) =>
  errorIntelligenceService.recordUserInteraction(interaction)
export const processLearningFeedback = (feedback) =>
  errorIntelligenceService.processLearningFeedback(feedback)
export const getPersonalizedExplanation = (error, userId, preferences) =>
