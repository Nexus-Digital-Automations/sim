...
export declare class ErrorRecoveryService {
     ...
     */
    executeWithRecovery<T>(operation: () => Promise<T>, context: {
        operationId: string;
        component: string;
    ...
    }, customConfig?: Partial<RetryConfig>): Promise<T>;
    /**
 ...
 */
export declare const executeWithRecovery: <T>(operation: () => Promise<T>, context: {
    operationId: string;
    component: string;
    category?: ErrorCategory;
    subcategory?: string;
 ...
 */
export declare function WithRetry(component: string, category?: ErrorCategory, subcategory?: string, customConfig?: Partial<RetryConfig>): (target: any, propertyName: string, descriptor: PropertyDescriptor) => PropertyDescriptor;
