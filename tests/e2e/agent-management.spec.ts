...
test.describe("Agent Management E2E", () => {
  ...
  test("complete agent creation workflow", async () => {
    ...
    await page.fill(
      '[data-testid="guideline-condition"]',
      testAgent.guidelines[0].condition,
    );
    await page.fill(
      '[data-testid="guideline-action"]',
      testAgent.guidelines[0].action,
    );
    await page
    ...
    await expect(
      page.locator(`text=${testAgent.guidelines[0].condition}`),
    ).toBeVisible();
    ...
    await page.fill(
      '[data-testid="guideline-condition"]',
      testAgent.guidelines[1].condition,
    );
    await page.fill(
      '[data-testid="guideline-action"]',
      testAgent.guidelines[1].action,
    );
    await page
      .locator('[data-testid="priority-slider"]')
    ...
    const firstGuideline = page
      .locator(`text=${testAgent.guidelines[0].condition}`)
      .first();
    const secondGuideline = page
      .locator(`text=${testAgent.guidelines[1].condition}`)
      .first();
    ...
    await expect(
      page.locator(`text=${testAgent.guidelines[1].condition}`),
    ).toBeVisible();
  ...
  test("guideline builder advanced features", async () => {
    ...
    await expect(
      page.locator('[data-testid="guideline-condition"]'),
    ).toHaveValue(/greeting|hello/i);
  ...
  test("journey creator functionality", async () => {
    ...
    await expect(
      page.locator('[data-testid="journey-state-start"]'),
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="journey-state-message"]'),
    ).toBeVisible();
    await expect(
      page.locator('[data-testid="journey-state-end"]'),
    ).toBeVisible();
  ...
  test("accessibility compliance", async () => {
    ...
    await expect(page.locator('[data-testid="agent-name"]')).toHaveAttribute(
      "aria-label",
    );
    await expect(
      page.locator('[data-testid="agent-description"]'),
