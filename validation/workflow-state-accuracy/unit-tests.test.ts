...
describe('Workflow Chat Sync Store', () => {
  ...
  describe('State Synchronization', () => {
    ...
    test('should handle workflow state changes correctly', () => {
      const stateChangeEvent: StateChangeEvent = {
        ...
        source: 'visual',
        data: {
          blocks: { 'new-block': { id: 'new-block', type: 'llm', name: 'New Block' } },
          edges: [],
        },
      }
  ...
  describe('Chat Command Parsing', () => {
    test('should parse add block commands correctly', () => {
      const testCases = [
        { input: 'add llm block', expected: { type: 'add_block', blockType: 'llm' } },
        { input: 'create api block', expected: { type: 'add_block', blockType: 'api' } },
        { input: 'add a condition', expected: { type: 'add_block', blockType: 'condition' } },
        { input: 'create transformer', expected: { type: 'add_block', blockType: 'transformer' } },
      ]
    ...
    test('should parse connection commands correctly', () => {
      const testCases = [
        ...
        },
        {
          ...
          expected: { source: 'the transformer', target: 'the condition block' },
        },
      ]
